      ...
      <div className="space-y-8">
                ...
                return (
                  <div key={req.id}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400">{req.listings?.category}</p>
                      ...
                      {alreadyRated ? (
                        ...
                        <button
                          onClick={() => setRatingModal({
                            ...
                            listingTitle:  req.listings?.title ?? "this listing",
                          })}
        ...
        {requests.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-gray-400 mt-1">Browse listings to start swapping</p>
          </div>
        )}
      </div>
    </>
